...
# MAGIC
# MAGIC This notebook creates all Bronze layer tables (raw data landing zone)
...
print("Created bronze_dim_supplier")
...
print("Created bronze_dim_material")
...
print("Created bronze_dim_product")
...
print("Created bronze_dim_customer")
...
print("Created bronze_dim_tariff")
...
print("Created bronze_fact_supplier_material")

# COMMAND ----------

# Material-Product Fact (BOM)
spark.sql(f"""
...
print("Created bronze_fact_material_product")

# COMMAND ----------

# Product-Customer Fact
spark.sql(f"""
...
print("Created bronze_fact_product_customer")

# COMMAND ----------

# Supplier-Supplier Fact (Tier relationships)
spark.sql(f"""
...
print("Created bronze_fact_supplier_supplier")

# COMMAND ----------

print(f"Bronze layer tables created successfully in {catalog}.{schema}")
